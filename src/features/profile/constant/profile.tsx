      ...
      items: [
        {
          ...
          list: [
            ...
            '커스텀 훅 및 HOC를 활용하여 상태 관리 로직과 렌더링 계층을 명확히 분리하는 컴포넌트 설계에 능숙합니다',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          subTitle: 'Playwright',
          list: [
            '크로스 브라우저 E2E 테스트를 구축하여 브라우저 간 렌더링 불일치 문제를 효과적으로 감지하고 해결했습니다',
            'Playwright Codegen을 활용하여 복잡한 사용자 인터랙션 시나리오를 자동 생성하고, CI/CD 파이프라인에 테스트를 통합한 경험이 있습니다',
          ],
        },
        {
          subTitle: 'Storybook',
          list: [
            'CDD 방법론에 기반하여 디자인 시스템 구현 및 문서화할 때 주도적으로 사용하였습니다',
            '서비스 정책 기반으로 스토리북 내 인터렉션 테스트 케이스를 자동화하여 UI 일관성을 유지했습니다',
            'Storybook 내 react-router 및 MSW를 통합하여 다양한 시나리오를 테스트하였습니다',
          ],
        },
      ],
    },
