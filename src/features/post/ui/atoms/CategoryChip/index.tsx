...
export default function CategoryChip(props: CategoryChipProps) {
  ...
  const categoryClass = `border-green-darker hover:dark:bg-[#1a1a1a] hover:bg-gray-100 bg-white dark:bg-black transition-color duration-200 hover:cursor-pointer px-5 py-1.5 border-[1px] rounded-md text-base max-md:text-sm font-light ${selectedClass}`;
