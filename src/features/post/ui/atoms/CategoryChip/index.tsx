...
export default function CategoryChip(props: CategoryChipProps) {
  ...
  const selectedClass = `${selected ? 'text-white hover:bg-green-darker dark:hover:bg-green-dark dark:border-green-brighter dark:bg-green-darker' : 'hover:dark:bg-[#1a1a1a] hover:bg-gray-100 text-green-darker dark:text-green-brighter bg-white dark:bg-transparent'}`;
