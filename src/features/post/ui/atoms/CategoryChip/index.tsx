...
export default function CategoryChip(props: CategoryChipProps) {
  ...
  const selectedClass = `${selected ? 'text-white dark:text-black bg-green-darker dark:bg-green-brighter' : 'text-green-darker dark:text-green-brighter bg-white dark:bg-black'}`;
