    ...
    <section className="isWrapper w-full flex-col md:gap-6 gap-3 justify-between align-center md:flex-row">
      {data.map((post: IFirebasePostReturn) => {
        ...
        return (
          ...
          >
            <div className="hover:bg-gray-100 hover:dark:bg-[#111] hidden-blur p-2 rounded-lg flex flex-col justify-between gap-6 md:gap-8 relative md:flex-row md:h-50">
              <div className="rounded-lg w-full aspect-video md:h-auto overflow-hidden shadow-md shadow-gray-300 dark:shadow-[#111] md:w-1/2">
                <img
                  className="bg-gray-100 dark:bg-[#111] animate-skeletonUI rounded-lg w-full h-full object-cover"
                  alt="썸네일"
              ...
              <div className="overflow-hidden flex justify-between gap-2 flex-col md:w-full md:pl-5">
                ...
                <div className="relative leading-normal h-[4.2rem] overflow-hidden after:content-[''] after:bg-gradient-to-r after:from-[rgb(255,255,255,0)] after:to-[rgb(255,255,255,1)] dark:after:to-[#222] after:p-3 after:pl-10 after:bottom-0 after:right-0 after:absolute after:-ml-10">
